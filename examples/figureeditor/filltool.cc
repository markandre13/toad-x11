...
main(int argc, char **argv, char **envv)
{
  ...
  //  intersect segment a12 with segment b0
      a[0].set(26977,17089);
      a[1].set(28130,18000);
      a[2].set(28201,17904);
      a[3].set(28272,17808);
  ...
  IntersectionPointList found;
  bezierIntersection(found, a, b, 0, 0);
  cout << "ok" << endl;
  return 1;
#endif
/*
  TPoint a0(113.75,86.25);
  TPoint a1(300,180);
  TPoint b0(130,110);
  TPoint b1(130,60);
  if (!lineIntersection(a0,a1,b0,b1))
    cout << "failed" << endl;
  else
    cout << "okay" << endl;
return 0;
  ...
  TWindow(parent, title)
{
...
#ifdef TEST01  
  p = new TFPath;
  p->polygon.push_back(TPoint( 40, 180));
  p->polygon.push_back(TPoint( 40, 180));
  p->polygon.push_back(TPoint(190,  90));
  p->polygon.push_back(TPoint(190,  90));
  model.add(p);

  p = new TFPath;
  p->polygon.push_back(TPoint(110,  90));
  p->polygon.push_back(TPoint(110,  90));
  p->polygon.push_back(TPoint(300, 180));
  p->polygon.push_back(TPoint(300, 180));
  model.add(p);
  
  p = new TFPath;
  p->polygon.push_back(TPoint(140, 180));
  p->polygon.push_back(TPoint(  0,   0));
  p->polygon.push_back(TPoint(320,   0));
  p->polygon.push_back(TPoint(180, 180));
  model.add(p);
#endif
  ...
  p = new TFPath;
#if 1
  p->polygon.push_back(TPoint( 180, 190));
  p->polygon.push_back(TPoint( 100, 180));
  p->polygon.push_back(TPoint(  20, 160));
  p->polygon.push_back(TPoint(  10,  95));
  p->polygon.push_back(TPoint(  20,  60));
  p->polygon.push_back(TPoint(  30,  50));
  p->polygon.push_back(TPoint( 180,  10));
#else
  p->polygon.push_back(TPoint( 180,  10));
  p->polygon.push_back(TPoint(  30,  50));
  p->polygon.push_back(TPoint(  20,  60));
  ...
  p = new TFPath;
  p->polygon.push_back(TPoint(  60,  10));
  p->polygon.push_back(TPoint( 200,  80));
  p->polygon.push_back(TPoint( 210, 100));
  p->polygon.push_back(TPoint(  40, 190));
  model.add(p);
#endif

#ifdef TEST04
  p = new TFPath;
  p->polygon.push_back(TPoint(  10, 195));
  p->polygon.push_back(TPoint(  10,   5));
  p->polygon.push_back(TPoint( 160,   5));
  p->polygon.push_back(TPoint( 310, 195));
  model.add(p);

  p = new TFPath;
  p->polygon.push_back(TPoint(  10, 150));
  p->polygon.push_back(TPoint(  30, 195));
  p->polygon.push_back(TPoint( 160, 195));
  p->polygon.push_back(TPoint( 200, 150));
  model.add(p);

  p = new TFPath;
  p->polygon.push_back(TPoint( 310, 150));
  p->polygon.push_back(TPoint( 190, 195));
  p->polygon.push_back(TPoint( 160, 195));
  p->polygon.push_back(TPoint( 120, 150));
  model.add(p);
#endif
#if 0
  p = new TFPath;
  p->polygon.push_back(TPoint(  10, 195));
  p->polygon.push_back(TPoint(  10,   5));
  p->polygon.push_back(TPoint( 310,   5));
  p->polygon.push_back(TPoint( 310, 195));
  model.add(p);
...
#if 0
  p = new TFPath;
  p->polygon.push_back(TPoint(  68, 100));
  p->polygon.push_back(TPoint(  40,  10));
  p->polygon.push_back(TPoint( 160,  20));
  p->polygon.push_back(TPoint( 190,  90));
  p->polygon.push_back(TPoint( 220, 100));
  p->polygon.push_back(TPoint( 280, 110));
  p->polygon.push_back(TPoint( 190, 130));
  p->polygon.push_back(TPoint( 110, 140));
  p->polygon.push_back(TPoint( 310, 150));
  p->polygon.push_back(TPoint( 250, 180));
  model.add(p);
  p = new TFPath;

  p->polygon.push_back(TPoint( 160, 190));
  p->polygon.push_back(TPoint( 100, 190));
  p->polygon.push_back(TPoint(  80, 160));
  p->polygon.push_back(TPoint(  40, 140));

  p->polygon.push_back(TPoint(   0, 190));
  p->polygon.push_back(TPoint(  10,  40));
  p->polygon.push_back(TPoint(  80,  60));

  p->polygon.push_back(TPoint( 150,  80));
  p->polygon.push_back(TPoint(  10,  20));
  p->polygon.push_back(TPoint(  60,  30));
  model.add(p);

  p = new TFPath;
  p->polygon.push_back(TPoint(  50, 195));
  p->polygon.push_back(TPoint(  50, 170));
  p->polygon.push_back(TPoint( 280, 150));
  p->polygon.push_back(TPoint( 300, 190));
  model.add(p);
#endif
  ...
  p->polygon.push_back(TPoint( 100, 190));
  p->polygon.push_back(TPoint( 100, 190));
  p->polygon.push_back(TPoint( 100,  40));
  p->polygon.push_back(TPoint( 100,  40));
  model.add(p);

  p = new TFPath;
  p->polygon.push_back(TPoint(  10,  50));
  p->polygon.push_back(TPoint(  10,  50));
  p->polygon.push_back(TPoint( 230,  50));
  p->polygon.push_back(TPoint( 230,  50));
  model.add(p);

  p = new TFPath;
  p->polygon.push_back(TPoint( 220,  40));
  p->polygon.push_back(TPoint( 220,  40));
  p->polygon.push_back(TPoint( 220, 160));
  p->polygon.push_back(TPoint( 220, 160));
  model.add(p);

  p = new TFPath;
  p->polygon.push_back(TPoint( 230, 150));
  p->polygon.push_back(TPoint( 230, 150));
  p->polygon.push_back(TPoint(  90, 150));
  p->polygon.push_back(TPoint(  90, 150));
  model.add(p);

  p = new TFPath;
  p->polygon.push_back(TPoint( 160, 160));
  p->polygon.push_back(TPoint( 160, 160));
  p->polygon.push_back(TPoint( 160,  80));
  p->polygon.push_back(TPoint( 160,  80));
  model.add(p);
...
#ifdef TEST06
  p = new TFPath;
  p->polygon.push_back(TPoint( 100, 160));
  p->polygon.push_back(TPoint( 100, 160));
  p->polygon.push_back(TPoint( 220,  40));
  p->polygon.push_back(TPoint( 220,  40));
  model.add(p);
  ...
  p = new TFPath;
  p->polygon.push_back(TPoint( 160, 150));
  p->polygon.push_back(TPoint( 160, 150)); 
  p->polygon.push_back(TPoint( 160,  50));
  p->polygon.push_back(TPoint( 160,  50));
  model.add(p);
...
#ifdef TEST07
  p = new TFPath;
  p->polygon.push_back(TPoint(  30, 40));
  p->polygon.push_back(TPoint(  30, 40));
//  p->polygon.push_back(TPoint( 200, 40));
//  p->polygon.push_back(TPoint( 210, 40));
//  p->polygon.push_back(TPoint( 220, 40));
  p->polygon.push_back(TPoint( 282, 40));
  p->polygon.push_back(TPoint( 282, 40));
  model.add(p);

  p = new TFPath;
  p->polygon.push_back(TPoint( 282, 160));
  p->polygon.push_back(TPoint( 282, 160));
  p->polygon.push_back(TPoint(  20, 160));
  p->polygon.push_back(TPoint(  20, 160));
  model.add(p);
  ...
  p = new TFPath;
  p->polygon.push_back(TPoint(  40,  20));
  p->polygon.push_back(TPoint(  40,  20));
  p->polygon.push_back(TPoint(  40, 180));
  p->polygon.push_back(TPoint(  40, 180));
  model.add(p);
  ...
  p = new TFPath;
  p->polygon.push_back(TPoint( 40,  5));
  p->polygon.push_back(TPoint( 160,  20));
  p->polygon.push_back(TPoint( 140, 110));
  p->polygon.push_back(TPoint( 160, 120));
  p->polygon.push_back(TPoint( 150, 130));
  p->polygon.push_back(TPoint( 180, 180));
  p->polygon.push_back(TPoint( 60, 195));
  model.add(p);

  p = new TFPath;
  p->polygon.push_back(TPoint( 280,  20));
  p->polygon.push_back(TPoint( 280,  20));
  p->polygon.push_back(TPoint( 280, 180));
  p->polygon.push_back(TPoint( 280, 180));
  model.add(p);
#endif
}
...
void
point(TPen *pen, const TPolygon &p, TCoord u)
{
  TCoord x = 0;
  TCoord y = 0;
  ...
  if (paintflag) {
    ...
    char buffer[10];
    snprintf(buffer, sizeof(buffer), "%lf", u);
    pen->drawString(x, y-40, buffer);

    pen->drawRectangle(x-20, y-20, 40, 40);
  }
}

void
point(TPen *pen, const TPoint *p, TCoord u)
{
  TCoord x = 0;
  TCoord y = 0;
  for(unsigned i=0; i<4; ++i) {
...
cout << "========================================================" << endl;
  TPen pen(this);
//  pen.scale(1.0/18.0, 1.0/18.0);
//  pen.translate(-20000, -15000);
  ::pen = &pen;
paintflag = true;
  // paint figures
  for (TFigureModel::const_iterator p = model.begin();
       ...
       ++p)
  {
    (*p)->paint(pen, TFigure::SELECT);
  }
//  pen.setLineWidth(12);
#ifdef TEST01
  TFPath *path = floodfill(model, 200, 120);
#endif
#ifdef TEST02
  TFPath *path = floodfill(model, 140, 100);
#endif
#ifdef TEST04
  TFPath *path = floodfill(model, 140, 100);
#endif
...
#endif
#ifdef TEST06
  TFPath *path = floodfill(model, 180, 140);
#endif
#ifdef TEST07
  TFPath *path = floodfill(model, 140, 100);
  if (!path)
  ...
  path->setColor(TRGB(255,128,0));
  path->paint(pen, TFigure::SELECT);
  delete path;
  path = floodfill(model, 180, 100);
#endif
  if (!path)
    return;
  ...
  switch(me.type) {
    case TMouseEvent::LDOWN:
          ...
          ++p)
      {
        ...
        if (!path)
          continue;
        cout << "check figure " << path << endl;
        for(unsigned i=0; i<8; ++i) {
          if (path->polygon[i].x-2<=me.x && me.x<=path->polygon[i].x+2 &&
              path->polygon[i].y-2<=me.y && me.y<=path->polygon[i].y+2)
          {
            handle = i;
            this->path = path;
            break;
    ...
    case TMouseEvent::MOVE:
     if (handle!=-1) {
if (path->polygon[handle].x == me.x &&
    path->polygon[handle].y == me.y)
    break;
        path->polygon[handle].x = me.x;
        path->polygon[handle].y = me.y;
cout << "mouse at: " << me.x << ", " << me.y << endl;
        invalidateWindow();
      }
      break;
...
floodfill(TFigureModel &model, TCoord x, TCoord y)
{
  ...
  // find a figure which is nearest to points (x, y) left side:
  
  // 1st: calculate all intersections with a horizontal line
  // 2nd: find the nearest intersection on the left
#ifdef DEBUG
...
//  const_cast<TFPath*>(nearpath)->setLineColor(TRGB(0,0,255));
  
  // find all figures which intersect with 'nearpath'
...
cout << "    taking : degree=" << dp->degree << ", path=" << dp->path << endl;
        ...
        if (segmentstack.size()<=1/*empty()*/) {
          cout << "  no minp and can not backtrace" << endl;
          return 0;
        }
...
pen->setColor(0,0,0);
if (!backtrace) {
  pen->drawString(10, 10, "collected_intersections_after_taking_new_direction");
} else {
  pen->drawString(10, 10, "collected_intersections_after_backtrace");
}
if (!minp) {
...
pen->drawString(10, 10 + 2*14 * 96, "circle_indicates_current_position");
pen->drawString(10, 10 + 3*14 * 96, "orange_cross_indicates_nearest_point_found");
pen->drawString(10, 10 + 4*14 * 96, "blue_crosses_indicate_wrong_order_of_intersection_entry");
pen->showPage();
}
#endif
